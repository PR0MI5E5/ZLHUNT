...
from ZLHUNT.Login import Login
    ...
    def run(self):
        ...
        for username in accounts_usernames:
            if not username in cookies_usernames:
                ...
                # 成功获取
                if result:
                    cookies = self.process_cookies(result)
...
class ZlHuntCookiesGenerator(CookiesGenerator):
    ...
    def new_cookies(self, username, password):
        ...
        :return: 用户名和Cookies
        """
        return Login(username, password, self.browser).main()


if __name__ == '__main__':
    generator = ZlHuntCookiesGenerator()
    generator.run()
